# Read in CSV file
sta_meta <- read.csv("data/portal_stations.csv", stringsAsFactors = F) #This addition will
# take characters as what they are not factors
...
summary(sta_meta) #summary of data, can get some information about NAs
